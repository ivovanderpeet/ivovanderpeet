...
global x x_u y y_v u v pc T rho mu Gamma b SMAX SAVG aP aE aW aN aS eps k...
    u_old v_old pc_old T_old Dt eps_old k_old uplus yplus yplus1 yplus2 JBOT JMID JTOP HBOT HMID HTOP COFLOW p Cp
% constants
...
NPJ        = 41;        % number of grid cells in y-direction [-]
JBOT = 2:round((NPJ-1)/2) + 1;
JMID = max(JBOT) + 1;
JTOP = JMID+1:NPJ+1;
