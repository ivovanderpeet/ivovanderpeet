...
% constants
global NPI NPJ JBOT JMID JTOP LARGE SMALL BIG nBAFFLE iBAFFLE hBAFFLE sideBAFFLE
global Dt gamma1 beta1 Dy kinematic_mu
% variables
...
for I = Istart:Iend
    ...
    for J = Jstart:Jend
        ...
        if J == 2 || J == NPJ+1
            SP(I,J) = -LARGE;
            Su(I,J) = LARGE*6*kinematic_mu(I,J)/(beta1*(Dy/2)^2); % Kinematic viscosity v = 1e-6 (at 20C)
